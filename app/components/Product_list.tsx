  ...
  return (
        <div className="flex flex-wrap justify-center gap-8 text-center w-5/6 ">
            {products.map((product) => (
                <div key={product.id} className="flex basis-1/5 flex-col items-center hover:border-purple-800 border-solid border-2 rounded">     
                    <Link href="/#" className="flex flex-col items-center">
                        ...
                        <p className="text-2xl h-8 text-red-600 font-black">{product.price.toNumber()} kr</p>
                        <small className="text-slate-400">{product.weight}g</small>
